...
velocity cohesion(std::vector<boid> const&, int const, double const,
                  boid const&, double d);
...
std::vector<boid> boids_generator(int, const double, const double,
                                  const double);
...
std::vector<boid> update_boids(std::vector<boid>&, double const, double const,
                               ...
                               int const, const double, const double,
